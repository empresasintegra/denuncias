    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('denuncia_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appkarin.denuncia')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(auto_now_add=True)),
                ('denuncia_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appkarin.denuncia')),
                ('estado_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appkarin.denunciaestado')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appkarin.categoria')),
            ],
            options={
                'verbose_name': 'Item',
