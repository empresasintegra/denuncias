...
% PASO 3: MODALIDAD ANÓNIMA
{\color{integraazul}\Large\textbf{PASO 3: MODALIDAD ANÓNIMA}}

\vspace{0.3cm}

% Información de denuncia anónima
\noindent
\begin{tabularx}{\textwidth}{|>{\columncolor{integraazul}\color{white}\bfseries}X|}
\hline
...
% Información del denunciante anónimo
\noindent
\begin{tabularx}{\textwidth}{|>{\columncolor{integraazul}\color{white}\bfseries}X|}
\hline
...
% Nota importante para usuarios anónimos
\begin{center}
